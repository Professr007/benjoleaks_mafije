...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://benjoleaks_mafije/close', JSON.stringify({}));
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://benjoleaks_mafije/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'SELECTED') {
            ...
            $(this).text('SELECTED');
            $.post('https://benjoleaks_mafije/addjob', JSON.stringify({
